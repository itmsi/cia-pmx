...
<div style="max-width: 600px; margin: 0 auto;">
    <div style="margin-bottom: 30px;">
        ...
        <h1 style="margin: 0; color: #2c3e50;">Create Role</h1>
        <p style="margin: 5px 0 0 0; color: #5f6368;">Create a new role with permissions</p>
    </div>
        ...
        <form method="post" action="/roles">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input 
                    ...
                    value="<?= old('name') ?>"
                    required
                    placeholder="e.g., Admin, Project Manager"
