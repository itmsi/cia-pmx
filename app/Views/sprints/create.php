...
<div style="max-width: 700px; margin: 0 auto;">
    <div style="margin-bottom: 30px;">
        ...
        <h1 style="margin: 0; color: #2c3e50;">Create Sprint</h1>
        ...
        <form method="post" action="/sprints">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input 
                    ...
                    value="<?= old('name') ?>"
                    required
                    placeholder="e.g., Sprint 1, Sprint Backend"
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
                ...
                <div>
                    ...
                    <select name="duration_weeks" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;">
                        <option value="1" <?= old('duration_weeks', '2') == '1' ? 'selected' : '' ?>>1 week</option>
                        <option value="2" <?= old('duration_weeks', '2') == '2' ? 'selected' : '' ?>>2 weeks</option>
                        <option value="3" <?= old('duration_weeks', '2') == '3' ? 'selected' : '' ?>>3 weeks</option>
                        <option value="4" <?= old('duration_weeks', '2') == '4' ? 'selected' : '' ?>>4 weeks</option>
                    </select>
                </div>
            </div>

            <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 30px;">
                <a href="/sprints?project_id=<?= $project['id'] ?>" class="btn btn-outline">Cancel</a>
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Create Sprint
                </button>
            </div>
        </form>
    </div>
