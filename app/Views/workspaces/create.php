...
<div style="max-width: 600px; margin: 0 auto;">
    <div style="margin-bottom: 30px;">
        ...
        <h1 style="margin: 0; color: #2c3e50;">Create Workspace</h1>
    </div>
        ...
        <form method="post" action="/workspaces">
            ...
            <div style="margin-bottom: 20px;">
                ...
                >
                    ...
                    <option value="Asia/Jakarta" <?= old('timezone') === 'Asia/Jakarta' ? 'selected' : '' ?>>Asia/Jakarta</option>
                    <option value="Asia/Singapore" <?= old('timezone') === 'Asia/Singapore' ? 'selected' : '' ?>>Asia/Singapore</option>
                </select>
            </div>

            <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 30px;">
                <a href="/workspaces" class="btn btn-outline">Cancel</a>
